    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone_antigo', models.CharField(max_length=11, null=True)),
                ('telefone_atualizado', models.CharField(max_length=11, null=True)),
                ('responsavel', models.ForeignKey(db_column='responsavel', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='infantID_coleta.responsvel')),
            ],
            options={
